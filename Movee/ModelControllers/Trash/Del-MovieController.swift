...
//import Foundation
//
//class TVShowController: MovieController {
//    override func fetchDetails() {
//        guard let movieId = movieId else { return }
//        
//        let _ = TMDBClient.shared.getTvShowDetails(id: movieId) { result in
//            switch result {
//            case .success(let tvshow):
//                //self.movie = tvshow.transformToMovie()
...
//    
//    internal var isDetailsFetched = false
//
